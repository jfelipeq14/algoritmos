...
const cantidadPiezas = parseInt(prompt("Digite la cantidad de piezas: "))
const valorPiezas = parseInt(prompt("Digite el valor de cada pieza: "))

// proceso
// obtener el valor de la compra
const totalCompra = cantidadPiezas * valorPiezas
...
// valores de pago
const propio = totalCompra * porcentajePropio
const fabricante = totalCompra * porcentajeFabricante

// credito del fabricante
const totalCredito = fabricante + (fabricante * 0.20)
